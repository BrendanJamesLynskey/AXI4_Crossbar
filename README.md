...
|--------|------|-----|------|-----|------------|
| axi_xbar_top | 906 | 42 | 0 | 0 | 116.6 |

*Auto-generated by Vivado batch synthesis. Clock target: 100 MHz. Default parameterisation (2 masters, 3 slaves, 32-bit data/addr).*
